    ...
    >
      ...
      <div className="container px-4 py-16 mx-auto max-w-6xl relative z-10">
        ...
        >
          ...
          >
            {[
              { icon: Github, href: content.socialLinks.github, label: "GitHub" },
              { icon: Linkedin, href: content.socialLinks.linkedin, label: "LinkedIn" },
              { icon: Mail, href: `mailto:${content.socialLinks.email}`, label: "Email" },
              ...(content.socialLinks.twitter
                ? [{ icon: Twitter, href: content.socialLinks.twitter, label: "Twitter" }]
                : []),
